		...
		<div class="row" style="margin-top: 20px;">
			<div class="col-md-12">
			    <div class="honeypress-page" style="border: none;box-shadow: none;">
					<div class="mockup">
			    		<img src="<?php echo esc_url( HONEYPRESS_THEME_URI . '/free/admin/assets/img/mockup-lite.png' ); ?>" width="100%">
			    	</div>
				</div>	
			</div>		
		</div>
			...
			<div class="col-md-6">
				...
				<div class="honeypress-page">
					...
					<div class="honeypress-page-content">
						<ul class="honeypress-page-list-flex">
							<li>
								<a class="honeypress-page-quick-setting-link" href="<?php echo esc_url('https://honeypress.spicethemes.com/'); ?>" target="_blank"><?php echo esc_html__('HoneyPress Demo','honeypress'); ?></a>
							</li>
							<li>
								<a class="honeypress-page-quick-setting-link" href="<?php echo esc_url('https://honeypress-pro.spicethemes.com/'); ?>" target="_blank"><?php echo esc_html__('HoneyPress Pro Demo','honeypress'); ?></a>
							</li>
							<li>
