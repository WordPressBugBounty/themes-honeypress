 ...
 */
require( HONEYPRESS_THEME_DIR . '/free/inc/theme-setup.php');
...
add_action( 'init', function() {
    ...
    if ( 'HoneyPress' == $honeypress_theme->name  || 'HoneyPress Pro' == $honeypress_theme->name ) {
        if ( is_admin() ) {
            require HONEYPRESS_THEME_DIR . '/free/admin/admin-init.php';
        }
    }
});
...
if ( ! function_exists( 'honeypress_customizer_preview_scripts' ) ) {
	function honeypress_customizer_preview_scripts() {
		wp_enqueue_script( 'honeypress-customizer-preview', trailingslashit( get_template_directory_uri() ) . 'free/inc/customizer-slider/js/customizer-preview.js', array( 'customize-preview', 'jquery' ) );
	}
}
add_action( 'customize_preview_init', 'honeypress_customizer_preview_scripts' );

//Alpha Color Control
require( HONEYPRESS_THEME_DIR .'/free/inc/customizer/customizer-alpha-color-picker/class-honeypress-customize-alpha-color-control.php');

/**
* Register Widget
*/
require( HONEYPRESS_THEME_DIR . '/free/inc/widget/register-widget.php');
require( HONEYPRESS_THEME_DIR . '/free/inc/widget/wdl_social_icon.php');
require( HONEYPRESS_THEME_DIR . '/free/inc/widget/wdl_topbar_info.php');

/**
* Breadcrumb setting
*/
require( HONEYPRESS_THEME_DIR . '/free/inc/breadcrumbs/breadcrumbs.php');

/**
* Register css, js and font
*/
require( HONEYPRESS_THEME_DIR . '/free/inc/script/scripts.php');
require( HONEYPRESS_THEME_DIR . '/free/inc/font/font.php');

/**
* Nav walker
*/
require( HONEYPRESS_THEME_DIR . '/free/inc/menu/default_menu_walker.php');
require( HONEYPRESS_THEME_DIR . '/free/inc/menu/honeypress_nav_walker.php');


/**
* helder function
*/
require( HONEYPRESS_THEME_DIR . '/free/inc/custom-style/custom-css.php');
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/helper-function.php');
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer-slider/customizer-slider.php');
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer-image-radio/customizer-image-radio.php');
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer-toggle/customizer-toggle.php');
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer-text-radio/customizer-text-radio.php');
/**
* Customizer functionality
*/
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/customizer_sections_settings.php' );
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/customizer_typography.php' );
require( HONEYPRESS_THEME_DIR . '/free/inc/customizer/customizer_color_back_settings.php');
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/customizer.php' );
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/customizer_theme_style.php' );
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/blog-page-options.php' );
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/single-blog-options.php' );
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/customizer-pro-feature.php' );
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/general_settings.php' );
require ( HONEYPRESS_THEME_DIR . '/free/inc/customizer/customizer-recommended-plugin.php');
require_once HONEYPRESS_THEME_DIR . '/free/inc/class-tgm-plugin-activation.php';
...
function honeypress_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name'     => esc_html__('Spice Social Share', 'honeypress'),
            'slug'     => 'spice-social-share',
            'required'  => false,
        ),
		array(
            'name'     => esc_html__('Seo Optimized Images', 'honeypress'),
            'slug'     => 'seo-optimized-images',
            'required'  => false,
            ),
		array(
            'name'     => esc_html__('Spice Blocks', 'honeypress'),
            'slug'     => 'spice-blocks',
            'required'  => false,
            )
