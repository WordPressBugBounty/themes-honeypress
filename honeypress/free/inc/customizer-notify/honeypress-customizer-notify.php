...
class Honeypress_Customizer_Notify extends \stdClass {
	...
	public function customizer_notify_scripts_for_customizer() {
		...
		wp_enqueue_style( 'honeypress-customizer-notify-css', HONEYPRESS_THEME_URI . '/free/inc/customizer-notify/css/honeypress-customizer-notify.css', array());
		...
		wp_enqueue_script( 'honeypress-customizer-notify-js', HONEYPRESS_THEME_URI . '/free/inc/customizer-notify/js/honeypress-customizer-notify.js', array( 'customize-controls' ));
		wp_localize_script(
	...
	public function plugin_notification_customize_register( $wp_customize ) {
		...
		require_once HONEYPRESS_THEME_DIR . '/free/inc/customizer-notify/honeypress-customizer-notify-section.php';
