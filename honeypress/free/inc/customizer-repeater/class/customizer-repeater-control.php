...
class Honeypress_Repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( HONEYPRESS_THEME_DIR . '/free/inc/customizer-repeater/inc/icons.php' ) ) {
			$this->customizer_icon_container =  'free/inc/customizer-repeater/inc/icons';
		}
	...
	public function enqueue() {
		wp_enqueue_style( 'font-awesome', HONEYPRESS_THEME_URI . '/free/assets/css/font-awesome/css/all.min.css', array(), 999 );

		wp_enqueue_style( 'honeypress_customizer-repeater-admin-stylesheet', HONEYPRESS_THEME_URI . '/free/inc/customizer-repeater/css/admin-style.css', array(), 999 );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'honeypress_customizer-repeater-script', HONEYPRESS_THEME_URI . '/free/inc/customizer-repeater/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), 999, true  );

		wp_enqueue_script( 'honeypress_customizer-repeater-fontawesome-iconpicker', HONEYPRESS_THEME_URI . '/free/inc/customizer-repeater/js/fontawesome-iconpicker.js', array( 'jquery' ), 999, true );

		wp_enqueue_style( 'honeypress_customizer-repeater-fontawesome-iconpicker-script', HONEYPRESS_THEME_URI . '/free/inc/customizer-repeater/css/fontawesome-iconpicker.min.css', array(), 999 );
	}
	...
	public function render_content() {
		...
		<div class="customizer-repeater-general-control-repeater customizer-repeater-general-control-droppable">
			...
			<input type="hidden" value="<?php echo count( $json ); ?>" id="honeypress_service_limit"/>
