...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        if(jQuery("#honeypress_service_limit").val()==3)
        {
           jQuery(".customizer_honeypressservice_upgrade_section").show();
            return false;
        }
        else
        {
           var total_services_sections=parseInt(jQuery("#honeypress_service_limit").val())+1;
           jQuery("#honeypress_service_limit").val(total_services_sections)
           if(jQuery("#honeypress_service_limit").val()>3)
        {
           jQuery(".customizer_honeypressservice_upgrade_section").hide();
        }
        }
    ...
    theme_conrols.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        var total_service= parseInt(jQuery("#honeypress_service_limit").val())-1;
       jQuery("#honeypress_service_limit").val(total_service);
