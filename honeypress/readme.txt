...
Contributors: spicethemes, freemius
...
Honeypress WordPress Theme, Copyright (C) 2019-2026, SpiceThemes
Honeypress is distributed under the terms of the GNU GPL

== Changelog ==

@Version 2.5.2
* Added post navigation and releted post section in honeypress lite theme.
* Added post navigation and releted post section variations for pro theme.
...
@Version 2.4.6
* Added Gutenberg editor section functionlity on business template.

@Version 2.4.5.1
* Added escaping function on missing places.
...
@Version 2.4.1
* Fixed PHP version 8 warning issue.
...
* Recommended SEO optimized images and Spice Block plugin.

@Version 2.3.7
* Fixed the menu style issue in responsive view.
* Updated the mockup image.
...
Copyright (C) 2019-2026, SpcieThemes and available as [GPLv3](https://www.gnu.org/licenses/gpl-3.0.en.html)